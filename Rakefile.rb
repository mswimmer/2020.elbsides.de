...
namespace :notify do
  ...
  task :pingomatic do
    begin
      ...
      XMLRPC::Client.new('rpc.pingomatic.com', '/').call('weblogUpdates.extendedPing', 'Elbsides' , 'https://2020.elbsides.de', 'https://2020.elbsides.de/feed.xml')
    rescue LoadError
  ...
  task :google do
    begin
      ...
      Net::HTTP.get('www.google.com', '/webmasters/tools/ping?sitemap=' + URI.escape('https://2020.elbsides.de/sitemap.xml'))
    rescue LoadError
  ...
  task :bing do
    begin
      ...
      Net::HTTP.get('www.bing.com', '/webmaster/ping.aspx?siteMap=' + URI.escape('https://2020.elbsides.de/sitemap.xml'))
    rescue LoadError
...
task :s3_website do
  ...
  system "aws s3 sync _site/ s3://2020.elbsides.de/ --delete --exclude \".DS_Store\" --exclude \"*.yml\" "
end
